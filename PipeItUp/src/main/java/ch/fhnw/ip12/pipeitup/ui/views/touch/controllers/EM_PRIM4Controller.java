...
public class EM_PRIM4Controller extends TouchUiController{
	@FXML
	...
	public void handleBArrow() throws Exception{
		viewModel.currentScene.setValue(TouchScene.EM_PRIM3);
	}
	@Override
	public void initializeController() {
		...
		//edge89.edgeState.setValue(EdgeState.INVALID_SELECTION);
		...
		edge811.edgeState.setValue(EdgeState.BLINKING);
		...
		EdgeViewModel edge1114 =gameboardViewModel.graphViewModel.getValue().edgeViewModels.stream().
				...
				findFirst().get();
		edge1114.edgeState.setValue(EdgeState.UNSELECTED);
