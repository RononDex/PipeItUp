...
public class PrimGAMEMODEController extends TouchUiController{

	@FXML
	Button backarrow, randomgame, prebuilt, highscore;

	public void handleBackarrow() throws Exception{
		viewModel.currentScene.setValue(TouchScene.GAMEMODE_MENU);
	}

	public void handleRandomgame() throws Exception{
